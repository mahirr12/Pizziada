    ...
    return (
        <main className='min-h-[90vh]'>
            <div className='bg-[#ccc] h-[70px] text-center py-[15px] sm:ml-[30px] sm:mr-[30px] lg:mt-[30px] lg:flex lg:justify-center lg:gap-[20px]'>
                ...
                <input className='p-[8px] border border-[#0F9675] rounded-md mx-[10px] w-[230px]' type="text"/>
                <button className=' bg-[#0F9675] border-[0] rounded-md  h-[40px] w-[85px]'>Daxil edin</button>
            </div>
