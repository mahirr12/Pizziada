    ...
    return (
        <header>
            <div className='h-[80px] flex justify-around lg:justify-between lg:ml-[60px] py-[20px]'>
                <Link to={"/"}>
                    <img 
                     className='w-[100px] py-[9px] ml-[-20px] mt-[-17px] lg:w-[190px] xl:w-[300px] xl:mt-[-17px]'
                     src="https://i.imgur.com/3ItAtC5.png" alt="" />
                </Link>
                ...
                <div className='lg:flex lg:gap-[150px] xl:gap-[200px] 2xl:gap-[400px] ekoo:hidden'>
                    ...
                    <div className='flex gap-5 '>
                        <div className='flex'>
                            <img src="https://www.papajohns.az/images/globe-1.svg" alt="globe" />
                ...
                <div className='flex gap-[100px]'>
                    <div className='lg:hidden'>
                        <img className='w-[25px]' src="https://www.papajohns.az/images/globe-1.svg" alt="globe" />
                                    ...
                                    <div key={i} className='flex justify-between mt-9 bg-[#ccc] m-4 rounded-xl'>
                                        ...
                                        <div>
                                            ...
                                            <div className='flex pt-[30px] mr-3'>
                                                <button className='bg-[#0F9675] text-white w-[30px] rounded-lg mr-2'>-</button>
                                                <p>{item.count}</p>
                                                <button className='bg-[#0F9675] text-white w-[30px] rounded-lg ml-2'>+</button>
                                            </div>
                                        </div>
                                    </div>
                                ))
            ...
            <div className='h-[60px] gap-2 scrollNone bg-[#FF834E] overflow-x-auto xl:text-[22px] xl:gap-[10px] xl:pl-[23%] 2xl:pr-[100px] 2xl:gap-[30px] lg:gap-[20px] lg:h-[90px] lg:text-[19px] lg:pt-[26px] text-[white] flex justify-center p-[15px] text-[15px]'>
                <Link to={"/kompaniyalar"} className='hover:text-[#aaa] cursor-pointer'><b>KAMPANİYALAR</b></Link>
