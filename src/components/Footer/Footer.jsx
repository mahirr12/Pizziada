...
function Footer() {
  return (
    ...
    <>
      <footer className='lg:hidden h-[45vh] lg:h-[10vh] mt-[70px] bg-[#FF834E] text-[white]'>
        <div className='font-bold pt-[30px] flex justify-around gap-10'>
          <div className='flex flex-col text-center'>
            ...
            <a href='#' className='inline-block pt-[10px] hover:text-[#aaa]'> Şərtlər və Qaydalar</a>
          </div>
      ...
      <footer className='bg-[#FF834E] mt-10 items-center p-10 ekoo:hidden lg:flex justify-between h-[10vh]'>
        <div className='flex gap-10'>
          ...
          <div className='flex gap-2 pt-1 text-white font-bold'>
            ...
            <a href='#' className='hover:text-[#aaa]'>Şərtlər və Qaydalar</a>
          </div>
        </div>
